window.addEventListener("resize", ()=>{
    ...
    PADZBOTstartPosition = {mX: 0, mTop: 0, height: parseInt(timgHeight), width:  (wh + ww) * 0.1, top: undefined, rttl: 0, rttr: 0, tttr: 3};
    PADZBOTendPosition = {mX: -wh * 0.55, mTop: wh * 0.275, height: wh, top: (0.5 * wh) - (PADZBOTstartPosition.height / 2), width: ww, rttl: -64.65, rttr: 51.73, tttr: 17};
